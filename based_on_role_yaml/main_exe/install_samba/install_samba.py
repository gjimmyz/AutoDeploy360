...
def main():
    ...
    commands = [
        ...
        f"cd {ansible_role_path} && `which ansible-playbook` -i get_real_can_loginhost_for_create_hosts_yaml/files/hosts.yaml playbook_name.yaml --extra-vars \"@roles_to_include.yaml\" --extra-vars \"roles=['install_samba_for_centos7','install_samba_for_ubuntu20']\""
    ]
